...
This project builds an Android WebView application that loads the deployed Fitness Tracker at `https://111.230.63.109:19797/`.
...
Offline mode is read-only. Creating or changing Fitness data still requires a network connection to the server.
